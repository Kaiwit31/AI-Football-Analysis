...
class TeamAssigner:
    ...
    def get_player_color(self, frame, bbox):
        ...
        cornor_clusters = [clustered_image[0,0],clustered_image[0,-1] ,clustered_image[-1,0], clustered_image[-1,-1]]
        non_player_cluster = max(set(cornor_clusters), key=cornor_clusters.count)
